      ...
      <div className={styles.containerLeft}>
        <div className={styles.titleTextContainer}>
          <p className={styles.mainTitle}>
            Collect, exchange and create amazing NFTs
            <span className={styles.mainTitleSmall}>
              {" "}
              <br /> on the best decentralized IMX marketplace that gives back
              to the community.
            </span>{" "}
          </p>
          ...
          <div className={styles.buttonContainer}>
            <a href="#collectionContainer">
              <button className={styles.button}>Start Browsing</button>
            </a>
